...
{/* Navbar Section */}
<div className="flex justify-between items-center py-4 px-6 border-b border-gray-300 dark:border-gray-600">
  ...
  <div className="flex items-center gap-4">
    <Button
      ...
      className="pr-4 border-r border-gray-900 dark:border-white"
    >
      Polls
    </Button>
    <Button
    ...
    {/* Display Username */}
    {user ? (
      <span className="pl-4 text-sm font-semibold text-green-900 dark:text-white transition-all duration-300 hover:text-yellow-600 dark:hover:text-yellow-600">
        User: {user.username}
      </span>
    ) : (
      <span className="pl-4 text-sm font-semibold text-green-900 dark:text-white transition-all duration-300 hover:text-yellow-600 dark:hover:text-yellow-600">
